...
export function SetupScreen({ onStart }) {
  ...
  return (
    <div style={{
      ...
      background: 'var(--bg-deep)', position: 'relative', overflow: 'auto'
    }}>
      ...
      <div style={{
        ...
        padding: '24px 16px', animation: 'slide-in-up 0.6s ease'
      }}>
        {/* Logo */}
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{
            fontSize: 'clamp(42px, 12vw, 72px)', fontWeight: 900, lineHeight: 1,
